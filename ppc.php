...
<head>
    ...
    <title>ReMark.KZ - PPC (Контекстная реклама)</title>
...
<body>
    ...
    <div class="col-md-10">
        <div class="o_nastxt">
            <div class="o_nas">PPC (Контекстная реклама)</div>
            <hr class="ln4" />
        </div>
    </div>
    <div class="col-md-2">
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="o_nastxt">
                <div class=""><a class="seo1">Что такое <strong>контекстная реклама?</strong><br />
                        <strong>Контекстная реклама</strong> – это реклама, которая показывается в поисковых сетях.<br />
                        <strong>Какие бывают поисковые сети? </strong>
                        Google, Яндекс, Mail.ru. На сегодняшний день в Казахстане популярна поисковая система Google ее используют 80% Казахстанцев. Остальные 20% распределены между другими поисковыми сетями.

                        <div class="smm1"><a><strong>Пример того как выглядит контекстная реклама в GOOGLE</strong></a>
                            <img class="smm2" width="100%" src="img/image1.png"></div>

                        <div class="seo2"><a class="seo1">Почему стоит использовать <strong>Контекстную рекламу</strong>?</a> Во первых вы платите за переход на ваш сайт, а не за показ рекламы. Это позволяет посчитать затраты на рекламу и прибыль от продажи. Во вторых это ГОРЯЧИЕ клиенты по исследованиям Google 90% покупателей, которые ищут товар или услугу хотят получить ее сейчас. В третьих контекстная реклама помогает найти НУЖНЫХ первых клиентов здесь и сейчас.
                        </div>
                </div>
            </div>
            <div class="col-md-3">
