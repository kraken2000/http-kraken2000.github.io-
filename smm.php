...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="o_nastxt">
                <div class=""><a class="seo1">Социальные сети</a> все больше набирают популярность со стороны пользователей. Этот тренд не остановить. Развитие социальных сетей положительно отразилось и на брендах. Теперь каждая компания выстраивает прямой контакт с клиентами. </div>
                <div class="smm1"><a class="seo1">Вкладываете в социальные сети большие ресурсы, подключаете таргетинг и не получаете необходимых результатов?</a> Причин достаточно: структура страницы, неинтересный контент, неправильная настройка рекламы в социальных сетях.</div>

                <div class="seo2"><a class="seo1">Мы проведем аудит аккаунтов в социальных сетях и разработаем стратегию</a> дальнейшего продвижения аккаунта. Обучим сотрудников, и вы сможете в дальнейшем самостоятельно продвигать работу в социальных сетях. </div>
            </div>
        </div>
        <div class="col-md-3">
        </div>
