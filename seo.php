...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <div class="">У вас есть сайт? И вы ожидаете, что теперь дела пойду в гору, но на деле оказывается, что сайты конкурентов появляются в первой 10 (десятке) в поисковой выдаче. А ваш сайт, где то на 30 или на 40 месте, а то и вообще нигде не показывается. Как решить эту проблему? Для этого есть специалист по SEO оптимизации. Давайте разберем, что такое SEO оптимизация.<br><br></div>
            <strong>SEO (Search Engine Optimization) оптимизация</strong> – это улучшение сайта для человека, так что бы он был максимально полезным и соответствовал его интересам.<br><br>

            Для этого поисковые сети разработали собственные алгоритмы, (их более 1 000) которые помогают определить какой сайт должен показываться на первом месте и тд. Кроме того эти алгоритмы НАКАЗЫВАЮТ сайты, которые не добросовестно пытаются повлиять на оптимизацию. В случаи нарушения одной из правил оптимизации ваш сайт могут понизить в позиции выдаче и это в лучшем случаи. В худшем случаи удалить из показа в поисковой выдаче на несколько лет. И все придется начинать сначала.

            <div class="smm1"><a><strong>Пример того где расположены SEO оптимизированные сайты</strong></a>
                <img class="smm2" width="100%" src="img/image2.png"></div>
            Как видно в примере в блоке «органическая выдача» показываются seo оптимизированные сайты. В чем преимущество seo оптимизированного сайта ваш сайт показывается в первой десятке и приносит вам клиентов на сайт без рекламы.<br><br>
            <strong>Сколько нужно времени для seo оптимизации?</strong><br><br>
            Что бы сайт появился в топ выдаче, потребуется минимум от 6 месяцев. Ведь процесс seo оптимизации трудоемкий, но в долгосрочно перспективе оправданный. <br> <br>
            Оставьте заявку у нас на сайте, и мы свяжемся с вами.<br><br><br>
        </div>
    </div>
    <div class="col-md-3">
    </div>
