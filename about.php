    ...
    <section class="about-cont">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <hr class="ln4" />
                <div class="o_nas1 o_nastxt">ТОО «DIGITAL–АГЕНТСТВО REMARK»</div>

                <a><a class="o_nas3">«Digital–агентство Remark»</a> занимается проведением маркетинговых, рекламных и PR кампаний с применением digital-инструментов. </a>

                <div class="o_nas4 o_nastxt">МИССИЯ АГЕНТСТВА:</div>
                <div>Расширять бизнес клиента через современные технологии и креативные решения. </div>

                <div class="o_nas4 o_nastxt">ЦЕННОСТИ:</div>
                <div class="o_nas5">1. Оперативность – агентство выполняет в максимально короткие сроки согласованные с заказчиком требования и задачи.<br />
                    2. Профессионализм – коллектив агентства состоит из профессионалов сферы интернет–маркетинга и постоянно повышает квалификацию сотрудников. <br />
                    3. Честность – агентство подробно отсчитывается перед заказчиком за проделанную работу, потраченные расходы, и постоянно работает над снижением стоимости услуг. <br />
                    4. Персонализация – агентство придерживается индивидуального подхода к каждому клиенту и предлагает услуги в зависимости от проекта, статуса и бюджета поставщика. </div>

                <div class="o_nas7 o_nastxt">Директор – <a class="o_nas6">Ернар Сейтахмет</a>, +7 707 174 81 94, yernar@remark.kz,<br />
                    Интернет-маркетолог – <a class="o_nas6">Есет Избасаров</a>, +7 747 299 40 15, eset@remark.kz@remark.kz, <br />
                    SEO специалист - <a class="o_nas6">Нуржол Табигат</a>, +7 701 548 18 27, seo@remark.kz.</div>

                <div class="o_nas8 o_nastxt">
                    <div>Реквизиты </div>
                    <div>ТОО «digital-агентство «Remark»<br />
                        БИН 180740012618<br />
                        ИИК KZ76914012203KZ006V9 <br />
                        БИК SABRKZKA<br />
                        Филиал ДБ АО «Сбербанк» в г.Астане, 010000<br />
                        г. Астана, р-н Есиль, ул. Достык д.5/2, ВП 202</div>
                </div>
